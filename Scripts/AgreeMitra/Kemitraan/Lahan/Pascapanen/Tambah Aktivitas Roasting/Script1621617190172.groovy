...
Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Pascapanen/Fermentasi, Pencucian, Pengemasan, Roasting, Sortir/JenisPascapanenRoasting_DropdownText'), 
    0)

Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Pascapanen/Fermentasi, Pencucian, Pengemasan, Roasting, Sortir/JenisPascapanenRoasting_DropdownText'), 
    0)
