...
Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Pascapanen/Penyulingan/JenisPascapanen_DropdownText'), 
    0)

Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Pascapanen/Penyulingan/JenisPascapanen_DropdownText'), 
    0)

Mobile.comment('Bahan Baku')

Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Pascapanen/Penyulingan/BahanBaku_TextField'), 
    0)

Mobile.setText(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Pascapanen/Penyulingan/BahanBaku_TextField'), 
    '1000', 0)

Mobile.comment('Hasil suling')

Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Pascapanen/Penyulingan/HasilSuling_TextField'), 
    0)

Mobile.setText(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Pascapanen/Penyulingan/HasilSuling_TextField'), 
    '1000', 0)
