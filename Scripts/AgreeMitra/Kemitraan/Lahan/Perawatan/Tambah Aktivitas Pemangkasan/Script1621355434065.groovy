...
//Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Petani_Text'), 0)
//
//Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Petani_Text'), 0)
...
Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemangkasan/JenisPerawatan_DropdownText'), 
    0)

Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemangkasan/JenisPerawatan_DropdownText'), 
    0)
...
Mobile.comment('Jenis Pemangkasan')

Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemangkasan/JenisPemangkasan_Field'), 
    0)

Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemangkasan/JenisPemangkasan_Field'), 
    0)

Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemangkasan/JenisPemangkasan_Text'), 
    0)

Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemangkasan/JenisPemangkasan_Text'), 
    0)

Mobile.comment('Populasi Saat Ini')

Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemangkasan/PopulasiSaatIni_TextField'), 
    0)

not_run: Mobile.setText(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemangkasan/PopulasiSaatIni_TextField'), 
    '1000', 0)
...
Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemangkasan/Catatan_TextField'), 
    0, FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemangkasan/Catatan_TextField'), 
    'Ea', 0)
