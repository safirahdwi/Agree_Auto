...
Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Bumbun, Chisel, Penyiangan, Turun Tanah, Universal/JenisPerawatan(Chisel) _DropdownText'), 
    0)
