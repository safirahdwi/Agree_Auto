...
Mobile.scrollToText('Turun Tanah', FailureHandling.STOP_ON_FAILURE)

Mobile.delay(2)

Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Bumbun, Chisel, Penyiangan, Turun Tanah, Universal/JenisPerawatan(TurunTanah)_DropdownText'), 
    0)

Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Bumbun, Chisel, Penyiangan, Turun Tanah, Universal/JenisPerawatan(TurunTanah)_DropdownText'), 
    0)
