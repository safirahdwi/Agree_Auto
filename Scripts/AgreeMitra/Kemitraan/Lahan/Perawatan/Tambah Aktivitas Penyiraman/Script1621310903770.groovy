...
Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Penyemprotan,Penyiraman,Penyulaman,Taksasi/JenisPerawatan(Penyiraman)_DropdownText'), 
    0)

Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Penyemprotan,Penyiraman,Penyulaman,Taksasi/JenisPerawatan(Penyiraman)_DropdownText'), 
    0)
