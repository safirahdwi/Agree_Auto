...
Mobile.scrollToText('Taksasi', FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Penyemprotan,Penyiraman,Penyulaman,Taksasi/JenisPerawatan(Taksasi)_DropdownText'), 
    0)
...
Mobile.comment('Produktivitas')

Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Penyemprotan,Penyiraman,Penyulaman,Taksasi/Produktivitas_TextField'), 
    0)

Mobile.setText(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Penyemprotan,Penyiraman,Penyulaman,Taksasi/Produktivitas_TextField'), 
    '1000', 0)

Mobile.comment('Catatan')

Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Penyemprotan,Penyiraman,Penyulaman,Taksasi/Catatan_TextField'), 
    0, FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Penyemprotan,Penyiraman,Penyulaman,Taksasi/Catatan_TextField'), 
    'Eaaa', 0)
