...
Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Bumbun, Chisel, Penyiangan, Turun Tanah, Universal/JenisPerawatan(Bumbun)_DropdownText'), 
    0)

Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Bumbun, Chisel, Penyiangan, Turun Tanah, Universal/JenisPerawatan(Bumbun)_DropdownText'), 
    0)
