...
Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemasangan Ajir/JenisPerawatan_DropdownText'), 
    0)

Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemasangan Ajir/JenisPerawatan_DropdownText'), 
    0)
...
Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemasangan Ajir/KebutuhanBahan_TextField'), 
    0)

Mobile.setText(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemasangan Ajir/KebutuhanBahan_TextField'), 
    '1000,067', 0)
...
Mobile.verifyElementExist(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemasangan Ajir/Catatan_TextField'), 
    0, FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/Aktivitas Petani/Perawatan/Pemasangan Ajir/Catatan_TextField'), 
    'Eaaa', 0)
