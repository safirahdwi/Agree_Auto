...
Mobile.setText(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/LuasLahan_TextField'), '5', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('AgreeMitra/Kemitraan/Lahan Besar/Lahan Petani/PanahSatuan_Icon'), 0)
